...
<style type="text/css">
  ...
  .div-comp-caro-odd{
    height: 60rem;
    background-image: url('<?=base_url("resource/user/image/divbg.jpg");?>');
  }
  ...
  .blinking-days{
    animation: blinkingDays 1.2s infinite;
  }
  .comp-font-progress{
    font-family: Trebuchet MS, sans-serif;
    font-size: 3rem;
  ...
  <!-- START REVOLUTION SLIDER 5.2.6 fullwidth mode -->
    <div id="rev_slider_3_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.2.6">
      <ul>  <!-- SLIDE  -->
        ...
        <!-- MAIN IMAGE -->
        <img src="<?=$rp;?>revolution/assets/a617d-slider2-bg.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
        <!-- LAYER NR. 1 -->
        <div class="tp-caption   tp-resizeme"
          ...
          style="z-index: 5;"><img src="<?=$rp;?>revolution/assets/92109-slide2-img8.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
        <!-- LAYER NR. 2 -->
        <div class="tp-caption   tp-resizeme"
          id="slide-4-layer-15"
          data-x="70"
          ...
          data-start="1500"
          data-responsive_offset="on"
          style="z-index: 6;"><img src="<?=$rp;?>revolution/assets/6ffd8-slide2-img2.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
        <!-- LAYER NR. 3 -->
        <div class="tp-caption   tp-resizeme"
          id="slide-4-layer-7"
          ...
          data-start="1500"
          data-responsive_offset="on"
          style="z-index: 7;"><img src="<?=$rp;?>revolution/assets/57034-slide2-img3.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
        <!-- LAYER NR. 4 -->
        <div class="tp-caption  text-orange tp-resizeme  text-center"
          ...
          data-splitout="none"
          data-responsive_offset="on"
          style="z-index: 13; white-space: nowrap; font-size: 65px; line-height: 65px; font-weight: 400; font-family:Lilita One;text-transform:uppercase;">welcome to the zayka</div>
        <!-- LAYER NR. 5 -->
        <div class="tp-caption   tp-resizeme"
          id="slide-4-layer-11"
          ...
          data-start="4200"
          data-responsive_offset="on"
          style="z-index: 9;"><img src="<?=$rp;?>revolution/assets/dc11c-slide2-img7.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
        <!-- LAYER NR. 6 -->
        <div class="tp-caption   tp-resizeme"
          id="slide-4-layer-8"
          data-x="192"
          ...
          data-start="3800"
          data-responsive_offset="on"
          style="z-index: 10;"><img src="<?=$rp;?>revolution/assets/77f8c-slide2-img4.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
        <!-- LAYER NR. 7 -->
        <div class="tp-caption   tp-resizeme"
          id="slide-4-layer-3"
          data-x="center" data-hoffset=""
          ...
          data-start="900"
          data-responsive_offset="on"
          style="z-index: 11;"><img src="<?=$rp;?>revolution/assets/bcac6-slide2-img1.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
        <!-- LAYER NR. 8 -->
        <div class="tp-caption   tp-resizeme"
          id="slide-4-layer-9"
          ...
          data-start="3800"
          data-responsive_offset="on"
          style="z-index: 12;"><img src="<?=$rp;?>revolution/assets/b4c34-slide2-img5.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
        <!-- LAYER NR. 9 -->
        ...
        <div class="tp-caption   tp-resizeme"
          ...
          data-start="5800"
          data-responsive_offset="on"
          style="z-index: 14;"><img src="<?=$rp;?>revolution/assets/c78fc-slide2-img6.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
        <!-- LAYER NR. 11 -->
        <div class="tp-caption tp-resizeme mo-sub-title-text"
          ...
          data-splitout="none"
          data-responsive_offset="on"
          style="z-index: 15; white-space: nowrap; font-size: 24px; line-height: 24px; font-weight: 400; color: rgba(255, 255, 255, 1.00);font-family:Lilita One;text-transform:uppercase;"> </div>
        </li>
      <!-- SLIDE  -->
        ...
        <div class="tp-caption   tp-resizeme"
          ...
          data-start="1500"
          data-responsive_offset="on"
          style="z-index: 7;"><img src="<?=$rp;?>revolution/assets/bcc28-img5.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
        <!-- LAYER NR. 4 -->
        <div class="tp-caption text-orange tp-resizeme  text-center"
        ...
        <div class="tp-caption   tp-resizeme"
          ...
          data-start="3800"
          data-responsive_offset="on"
          style="z-index: 10;"><img src="<?=$rp;?>revolution/assets/2db18-img2.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
        <!-- LAYER NR. 7 -->
        <div class="tp-caption   tp-resizeme"
          ...
          data-start="900"
          data-responsive_offset="on"
          style="z-index: 11;"><img src="<?=$rp;?>revolution/assets/06df7-img6.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
        <!-- LAYER NR. 8 -->
        <div class="tp-caption   tp-resizeme"
          ...
          data-start="3800"
          data-responsive_offset="on"
          style="z-index: 12;"><img src="<?=$rp;?>revolution/assets/32168-img4.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
        <!-- LAYER NR. 9 -->
        <div class="tp-caption tp-resizeme mo-details-text"
          ...
          data-splitout="none"
          data-responsive_offset="on"
          style="z-index: 8; white-space: nowrap; font-size: 16px; line-height: 24px; font-weight: 300; color: rgba(255, 255, 255, 1.00);font-family:Open Sans;text-align:center;">
          The Taste For Life.
        </div>
        <!-- LAYER NR. 10 -->
        <div class="tp-caption   tp-resizeme"
          ...
          data-start="5800"
          data-responsive_offset="on"
          style="z-index: 14;"><img src="<?=$rp;?>revolution/assets/ef0d8-img3.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
        <!-- LAYER NR. 11 -->
        <div class="tp-caption tp-resizeme mo-sub-title-text"
  ...
  <div>
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <ol class="carousel-indicators">
        <?php
          for($i=0;$i<(count($competition_data));$i++)
          {
            if($i==0)
            {
        ?>
      ...
      <div class="carousel-inner">
        <?php
          $j=0;
          foreach($competition_data as $cd)
          {
            if($j==0)
            {
        ?>
              <div class="item active">
                <div class="div-comp-caro-even">
        <?php
            }
            else
            {
        ...
        <?php
            ...
            $j++;
        ?>
                  <div class="row text-center div-comp-head-caro">
                    <h1 class="blinking">
                      <?=$cd->CompetitionTitle?>
                    </h1>
                  </div>
                  <div class="row">
                    <div class="col-md-6 text-center div-comp-font-caro blinking-days">
                      <font class="comp-font-caro">
                        Just <?=abs($cd->RemainingDays);?> Days
                        <br>
                        Remaining!!
                      </font>
                      <br>
                      <br>
                      <br>
                      <font class="comp-font-progress">
                        Competition: <?=$cd->CompetitionProgress?>
                        <br>
                        <?php
                          if($cd->CompetitionProgress=="Yet to start")
                          {
                        ?>
                        Starting On: <?=date('d-M-y',strtotime($cd->CompetitionStartDate))?> 
                        <?php
                          }
                          else
                          {
                        ?>
                        Ending On: <?=date('d-M-y',strtotime($cd->CompetitionEndDate))?>
                        <?php
                          }
                        ?>
                      </font>
                    </div>
                    <div class="col-md-6 div-comp-font-caro">
                      <font class="comp-font-caro2">
                        About Competition:
                      </font>
                      <br>
                      <font class="comp-desc-caro">
                        <?=$cd->CompetitionDescription;?>...
                      </font>
                      <br>
                      <form method="post" action="<?=site_url('Competition_user/index/'.$cd->CompetitionId);?>">
                        <button class="btn-comp-caro btn btn-lg">Read More <i class="fa fa-arrow-right"></i></button>
                      </form>
                    </div>
                  </div>
                </div>
        ...
        ?>
        <!-- <div class="item active">
                <img src="<?=base_url('resource/user/image/default.jpg');?>" alt="Chicago" style="width:100%; height: 55rem;">
        </div>
        <div class="item">
          <img src="<?=base_url('resource/user/image/default.jpg');?>" alt="Chicago" style="width:100%; height: 55rem;">
        </div>
...
<section class="about white-bg">
  <div class="object-bottom-top">
    <div class="object-left">
      <img class="img-responsive" src="<?=$rp;?>images/object/01.jpg" alt="">
    </div>
    <div class="object-right">
      <img class="img-responsive" src="<?=$rp;?>images/object/02.jpg" alt="">
    </div>
  </div>
      ...
      <div class="row">
        <div class="col-lg-12 col-md-12">
          <div class="section-title text-center">
            ...
            <h2> <span class="text-orange">Welcome to</span> The Zayka</h2>
      ...
      <div class="row">
        <div class="col-lg-7 col-md-7 col-sm-7 text-right">
          <div class="content mt-80">
            ...
            <img class="img-responsive mt-30" src="<?=$rp;?>images/arrow.png" alt="">
          </div>
        </div>
                ...
                <div class="bb-custom-side page-layout-3">
                  <div class="book-content text-center">
                    <div class="book-logo mt-30">
                      <img class="img-responsive center-block" src="<?=$rp;?>images/menu/book-logo.png" alt="">
                    </div>
                  ...
                  <div class="book-content">
                      ...
                      <div class="col-lg-12 col-md-12">
                        <div class="menu-body menu-left">
                          <div class="menu-thumbnail">
                            <img class="img-responsive center-block" src="<?=$rp;?>images/dish/01.png" alt="">
                          </div>
                    ...
                    <div class="row mb-50">
                      <div class="col-lg-12 col-md-12">
                        <div class="menu-body menu-left">
                          <div class="menu-thumbnail">
                            <img class="img-responsive center-block" src="<?=$rp;?>images/dish/02.png" alt="">
                          </div>
                          <div class="menu-details">
                            <div class="menu-title clearfix">
                              <h4>PREMIUM CAFE</h4>
                    ...
                    <div class="row mb-50">
                      <div class="col-lg-12 col-md-12">
                        <div class="menu-body menu-left">
                          <div class="menu-thumbnail">
                            <img class="img-responsive center-block" src="<?=$rp;?>images/dish/03.png" alt="">
                          </div>
                          <div class="menu-details">
                            <div class="menu-title clearfix">
                    ...
                    <div class="row">
                      <div class="col-lg-12 col-md-12">
                        <div class="menu-body menu-left">
                          <div class="menu-thumbnail">
                            <img class="img-responsive center-block" src="<?=$rp;?>images/dish/04.png" alt="">
                          </div>
                          <div class="menu-details">
                            <div class="menu-title clearfix">
                              <h4>PREMIUM The Zayka</h4>
                  ...
                  <div class="book-content">
                    ...
                    <div class="row mb-50">
                      <div class="col-lg-12 col-md-12">
                        <div class="menu-body menu-left">
                          <div class="menu-thumbnail">
                            <img class="img-responsive center-block" src="<?=$rp;?>images/dish/05.png" alt="">
                          </div>
                          <div class="menu-details">
                            <div class="menu-title clearfix">
                    ...
                    <div class="row mb-50">
                      <div class="col-lg-12 col-md-12">
                        <div class="menu-body menu-left">
                          <div class="menu-thumbnail">
                            <img class="img-responsive center-block" src="<?=$rp;?>images/dish/06.png" alt="">
                          </div>
                          <div class="menu-details">
                            <div class="menu-title clearfix">
                              <h4>French Toast</h4>
                    ...
                    <div class="row mb-50">
                      <div class="col-lg-12 col-md-12">
                        <div class="menu-body menu-left">
                          <div class="menu-thumbnail">
                            <img class="img-responsive center-block" src="<?=$rp;?>images/dish/07.png" alt="">
                          </div>
                          <div class="menu-details">
                            <div class="menu-title clearfix">
                    ...
                    <div class="row">
                      <div class="col-lg-12 col-md-12">
                        <div class="menu-body menu-left">
                          <div class="menu-thumbnail">
                            <img class="img-responsive center-block" src="<?=$rp;?>images/dish/08.png" alt="">
                          </div>
                          <div class="menu-details">
                            <div class="menu-title clearfix">
                              <h4>PREMIUM The Zayka</h4>
                  ...
                  <div class="book-content">
                    ...
                    <div class="row mb-50">
                      <div class="col-lg-12 col-md-12">
                        <div class="menu-body menu-left">
                          <div class="menu-thumbnail">
                            <img class="img-responsive center-block" src="<?=$rp;?>images/dish/09.png" alt="">
                          </div>
                          <div class="menu-details">
                            <div class="menu-title clearfix">
                    ...
                    <div class="row mb-50">
                      <div class="col-lg-12 col-md-12">
                        <div class="menu-body menu-left">
                          <div class="menu-thumbnail">
                            <img class="img-responsive center-block" src="<?=$rp;?>images/dish/10.png" alt="">
                          </div>
                          <div class="menu-details">
                            <div class="menu-title clearfix">
                    ...
                    <div class="row mb-50">
                      <div class="col-lg-12 col-md-12">
                        <div class="menu-body menu-left">
                          <div class="menu-thumbnail">
                            <img class="img-responsive center-block" src="<?=$rp;?>images/dish/11.png" alt="">
                          </div>
                          <div class="menu-details">
                            <div class="menu-title clearfix">
                              <h4>Eggs Benedict</h4>
                    ...
                    <div class="row">
                      <div class="col-lg-12 col-md-12">
                        <div class="menu-body menu-left">
                          <div class="menu-thumbnail">
                            <img class="img-responsive center-block" src="<?=$rp;?>images/dish/12.png" alt="">
                          </div>
                          <div class="menu-details">
                            <div class="menu-title clearfix">
                              <h4>PREMIUM The Zayka</h4>
                  ...
                  <div class="book-content">
                    ...
                    <div class="row mb-50">
                      <div class="col-lg-12 col-md-12">
                        <div class="menu-body menu-left">
                          <div class="menu-thumbnail">
                            <img class="img-responsive center-block" src="<?=$rp;?>images/dish/13.png" alt="">
                          </div>
                          <div class="menu-details">
                            <div class="menu-title clearfix">
                    ...
                    <div class="row mb-50">
                      <div class="col-lg-12 col-md-12">
                        <div class="menu-body menu-left">
                          <div class="menu-thumbnail">
                            <img class="img-responsive center-block" src="<?=$rp;?>images/dish/14.png" alt="">
                          </div>
                          <div class="menu-details">
                            <div class="menu-title clearfix">
                              <h4>Spring Salad</h4>
                    ...
                    <div class="row mb-50">
                      <div class="col-lg-12 col-md-12">
                        <div class="menu-body menu-left">
                          <div class="menu-thumbnail">
                            <img class="img-responsive center-block" src="<?=$rp;?>images/dish/15.png" alt="">
                          </div>
                          <div class="menu-details">
                            <div class="menu-title clearfix">
                    ...
                    <div class="row">
                      <div class="col-lg-12 col-md-12">
                        <div class="menu-body menu-left">
                          <div class="menu-thumbnail">
                            <img class="img-responsive center-block" src="<?=$rp;?>images/dish/16.png" alt="">
                          </div>
                          <div class="menu-details">
                            <div class="menu-title clearfix">
                              <h4>PREMIUM The Zayka</h4>
...
<section class="special-menu parallax" style="background-image: url(<?=$rp;?>images/bg/01.jpg);">
  <div class="page-section-ptb">
    <div class="container">
      <div class="row">
        <div class="col-lg-12 col-md-12">
...
<section class="our-menu page-section-pt parallax pb-30" style="background-image: url(<?=$rp;?>images/bg/06.jpg);">
  <div class="container">
    <div class="row">
      <div class="col-sm-12">
...
<section class="testimonials">
  ...
  <div class="object-bottom-top">
    <div class="object-right">
      <img class="img-responsive" src="<?=$rp;?>images/object/05.png" alt="">
    </div>
  </div>
  <div class="page-section-ptb">
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-4 col-md-4">
          <div class="testimonial-block left">
            <div class="testimonial-avatar">
              <img src="<?=$rp;?>images/team/01.jpg" alt="">
            </div>
        ...
        <div class="col-lg-4 col-md-4">
          <div class="testimonial-block left">
            <div class="testimonial-avatar">
              <img src="<?=$rp;?>images/team/02.jpg" alt="">
            </div>
            <div class="testimonial-info clearfix">
        ...
        <div class="col-lg-4 col-md-4">
          <div class="testimonial-block left">
            <div class="testimonial-avatar">
              <img src="<?=$rp;?>images/team/03.jpg" alt="">
            </div>
            <div class="testimonial-info clearfix">
    ...
    <div class="row">
      <div class="col-lg-4 col-md-4">
        <div class="newsletter-image">
          <img class="img-responsive center-block" src="<?=$rp;?>images/object/15.png" alt="">
        </div>
      </div>
