  ...
  <div class="inner-intro parallax bg-overlay-black-70" style="background-image: url(<?=$rp;?>images/bg/03.jpg);">
    <div class="container">
      <div class="row text-center intro-title">
        <h1 class="text-orange">Your Playlists</h1>
...
<!--=================================
  ...
  <div class="container"> 
    <div class="isotope popup-gallery columns-2" id="recipe-display">
      <?php
      foreach($playlist_data as $r)
      {
        ?>
        <div class="grid-item chinese mexican" id="rv-<?=$r->PlaylistId;?>">
          <div class="galllery-item">
            <span><img class="img-responsive recipebgimg" src="<?=base_url('resource/user/image/defaultplaylist.jpg');?>" alt=""></span>
            <div class="overlay">
              <div class="overlay-content">
                <h3><a href="<?=site_url('Playlist/display_playlist_recipes/').$r->PlaylistId;?>"><?=$r->PlaylistTitle;?></a></h3>
                On <b><?=$r->PlaylistCreatedDate;?></b>
                <br>
                <div class="row class-save-btn-div">
                  <form method="post" action="<?=site_url('Playlist/dlt_playlist/'.$r->PlaylistId);?>">
                    <button class="saved-btn btn" style="outline: none;" title="Delete Playlist" id="<?=$r->PlaylistId;?>">
