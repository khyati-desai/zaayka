...
<div class="page">
  ...
  <div class="page-content blue-grey-500">
    ...
    <!-- End Modal -->
    <!-- Modal -->
      <div class="modal fade" id="exampleGridRate" aria-hidden="true" aria-labelledby="exampleGridRate"
        role="dialog" tabindex="-1">
        <div class="modal-dialog modal-simple">
          <div class="modal-content" style="height: 80%;">
            <div class="modal-header">
              ...
              <h4 class="modal-title">Rated By: <b><?=count($rate_data)?> people</b></h4>
            </div>
            <div class="modal-body" style="overflow-y: scroll;">
              <div class="example-grid">
                <div class="row">
                          ...
                          <div class="media-body align-self-center">
                              <h4 class="mt-0 mb-5">  
                                  ...
                                  <div style="float: right;">
                                    <?=$r->Rate;?>
                                    <i class="fa fa-star" style="color: #f5e32b;"></i>
                                  </div>
                              </h4>
                          </div>
                        </div>
    ...
    <div class="card card-shadow">
      <div class="page-header" style="text-align: center;">
        ...
        <p class="card-text type-link" style="font-size: 130%;">
          ...
          <a href="#exampleGrid"  class="animation-example animation-hover hover" data-toggle="modal"><i class="icon wb-heart animation-scale-down" aria-hidden="true" style="color: #C82A65;" data-html="true" title='
              <?php
          ...
          <a href="#" class="animation-example animation-hover hover"><i class="icon wb-eye animation-scale-down" aria-hidden="true" style="color: #58373C ;"></i>
            <span><?php echo count($view_data)?></span>
          </a>
          <a href="#exampleGridRate" class="animation-example animation-hover hover" data-toggle="modal"><i class="hvr-icon-popup icon wb-star animation-scale-down" aria-hidden="true" style="color: #f5e32b;" title="given by: <?=count($rate_data)?> people" data-toggle="tooltip" data-placement="top"></i>
            <span>
            <?php
                              ...
                              <div class="media-body">
                                <div class="comment-body">
                                  ...
                                  <div class="comment-actions">
                                    <a id="Status-<?=$com->RecipeCommentId;?>">
                                      <?php
