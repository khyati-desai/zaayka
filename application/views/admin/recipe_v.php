            ...
            <div class="profile-brief" style="border:1px solid #eee;box-shadow: 0 0 10px rgba(0,0,0,.2);border-radius: 10px;">
              <div class="media">
                ...
                <p  class="card-text type-link" style="font-size: 130%;">
                  ...
                  <a href="#" class="animation-example animation-hover hover">
                      <i class="icon fa-eye animation-scale-down" 4iaria-hidden="true" style="color:   #58373C;"></i>
                    <span>
                      <?php
                      $cnt=0;
                  ...
                  <a href="#" class="animation-example animation-hover hover">
                      <i class="icon fa-star animation-scale-down" 4iaria-hidden="true" style="color: #F5E32B;"></i>
                    <span>
                      <?php 
                      $tot_rate=0;
