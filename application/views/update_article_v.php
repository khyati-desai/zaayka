    ...
    <div id="div_row" class="row col-md-8 col-md-offset-2" style="margin-bottom: 4rem;margin-top: 3rem;padding-bottom: 3rem;border-radius: 10px;">
      <div class="col-md-12" style="font-size: 4rem;font-family:'Amatic SC', cursive; margin-top: 4rem;margin-bottom: 5rem;text-align: center;">
        <span style="border-bottom: 1px solid white;box-shadow: 0px 0px 10px black;border-radius: 5%;width:30rem;padding: 1rem;">
          <i class="fa fa-newspaper-o" style="font-size:3.5rem;margin-right: 1.5rem;"></i>Edit Article</span>
      </div>
      <div class="col-md-12">
        <form action="<?=site_url('/Article_user/update_article/'),$article_data[0]->ArticleId;?>" method="POST" enctype="multipart/form-data" id="article_form" onsubmit="return add_article();">
          <div class="row">
            <div class="col-md-12">
              <div class="col-md-12">
                <p style="color: gray;font-weight: bold;">Article Title </p>
                  <input type="" name="aArticleTitle" id="aArticleTitle" value="<?=$article_data[0]->ArticleTitle;?>" placeholder="Enter Article Title" style="border-bottom: 1px solid black;background-color: #FBF8F7;">
                <p id="err_article_title" style="display:none;color: red;font-weight: bold;">hiii</p>
              </div>

              <div class="col-md-12" style="margin-top: 3rem;">
                <p style="color: gray;font-weight: bold;">Write Your Article Description Here..</p>
                <textarea id="NicEdit" name="NicEdit" cols="80" rows="5"><?=$article_data[0]->ArticleDescription;?></textarea>
              ...
              <div class="col-md-12" style="margin-top: 3rem;">
                <div class="col-md-6">
                  <div class="example-wrap">
                    <p style="color: gray;font-weight: bold;">Select Display Image</p>
                    <div class="example">
                      <input type="file" accept="image/*" id="aArticleImage" name="aArticleImage"
                      />
                    </div>
                    <div class="form-group">
                      <img src="<?=base_url('/resource/user/image/'),$article_data[0]->FeaturedImage;?>" height="150rem" weight="150rem" id="aArticleImageDisplay" style="border-radius: 5%;">
                    </div>
                  </div>
                </div>
              ...
              <div class="col-md-12" style="margin-top: 3rem;">
                <center>
                  <button type="submit" name="submit_upload" id="submit_upload"  class="button">Submit Article</button>
                </center>
              </div>
...
//<![CDATA[
  ...
  $(function(){
      $('#aArticleVideo').on('change',function(e){
        var imgsrc=URL.createObjectURL(e.target.files[0])
        /*$("#uAdminImage").val().replace(/C:\\fakepath\\/i, '');*/
        $('#aArticleVideoDisplay').attr('src',imgsrc);
      });
    });
</script>
<script type="text/javascript">
  ...
  { 
    ...
    if (flag==1) {
    return confirm("Are You Sure You Want To Edit This Article?") ;
    }
  }
</script>